...
#define EX_ABLE uint16_t(0x0001)
#define WR_ABLE uint16_t(0x0002)
#define RD_ABLE uint16_t(0x0004)
#define TYPE_FILE uint16_t(0x0100)
#define TYPE_DIR uint16_t(0x0200)
#define TYPE_LINK uint16_t(0x0400)
